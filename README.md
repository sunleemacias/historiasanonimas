...
La fase de historias tiene un temporizador de cinco minutos controlado por el servidor. Solo el anfitrión puede ver qué participantes ya enviaron su historia y cuántas faltan; cada participante ve únicamente su propio estado.
