...
type PartialResult = { storyNumber: number; choices: { id: string; name: string; votes: number }[] }
type GameState = { code: string; phase: Phase; participants: Participant[]; me: Participant; isHost: boolean; canStart: boolean; stories: Story[]; currentStory: Story | null; currentOptions: { id: string; name: string }[]; hasVotedCurrentStory: boolean; partialResults: PartialResult[]; scores: { id: string; name: string; score: number }[] }
