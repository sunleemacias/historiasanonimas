...
type GameState = { code: string; phase: Phase; participants: Participant[]; me: Participant; isHost: boolean; canStart: boolean; stories: Story[]; pendingStoryIds: string[]; scores: { id: string; name: string; score: number }[] }
